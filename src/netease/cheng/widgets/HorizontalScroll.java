...
public class HorizontalScroll extends ViewGroup {
	...
	@Override//为子视图分配位置时回调此方法该方法为每一个子视图分配全屏
    ...
    @Override//此方法计算尺寸---需要调用measure方法来分配尺寸--水平空间--垂直空间
    ...
    public void snapToDestination() {
    	...
    	/*
    	 * 计算目标屏幕//getScrollX()方法返回的是当前视图左边缘的X坐标--算法表示是否超过半屏
    	 * 返回可能0,1
    	 */
